...
{
    const char tokenFilePath[100]  =  "D:/txt/tokens.txt";  // tokens文件路径
    const char sourceFilePath[100]  =  "D:/txt/test3.txt";  // 源文件路径
...
// int main(){ 
//     const char tokenFilePath[100]  =  "D:/txt/tokens.txt";  // tokens文件路径
//     const char sourceFilePath[100]  =  "D:/txt/test1.txt";  // 源文件路径
